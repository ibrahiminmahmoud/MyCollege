...
import com.example.mycollege.view.home.cairo1


@Composable
fun Tablesded2(navController: NavController) {
                ...
                items(1) {
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = "محاضرات الفصل الدراسي الاول",
                        ...
                        Icon(
                            ...
                            modifier = Modifier
                                .clickable { navController.navigate("TablesViewer3") }
                        )
