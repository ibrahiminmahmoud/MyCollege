...
@Composable
fun Tablesded1(navController: NavController) {
    val scaffoldState = rememberScaffoldState(rememberDrawerState(DrawerValue.Closed))
    val scope = rememberCoroutineScope()

    Scaffold(
        scaffoldState = scaffoldState,
        topBar = { TopBar(scope = scope, scaffoldState = scaffoldState,"العملي") },
        drawerContent = {
                ...
                items(1) {
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text = " العملي للفصل الدراسي الاول",
                        ...
                        Icon(
                            ...
                            modifier = Modifier
                                .clickable { navController.navigate("TablesViewer2") }
                        )
